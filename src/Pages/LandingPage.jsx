  ...
  return (
    <>
      ...
      <section
        ...
        className="section-1 d-flex flex-column align-items-center"
      >
        <h1
        ...
        <div className="position-relative">
          <img
            id="CreateChatBot"
            style={{ height: "52vh", width: "auto", paddingTop: "30px" }}
            src={demo1}
            alt="illustration1"
            className="img-fluid"
          />
      ...
      <section id="feature-section" className="section-2">
        ...
        <div className="container card-container">
          <div className="row justify-content-around">
            {[
              {
                icon: <TbHandClick className="icon" />,
                title: "Easy To Use",
              ...
              {
                icon: <VscSettings className="icon" />,
                title: "Customizable",
                description: "Customize your chatbot to your needs",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="feature-card col-lg-3 col-md-3 col-sm-6"
              >
                {feature.icon}
                <h3>{feature.title}</h3>
        ...
        <div className="section-3">
          ...
          <div className="d-flex flex-column align-items-center">
            <ul className="steps">
              <li>
                Click on{" "}
                <Link onClick={scrollToCreateChatBot}>Create ChatBot</Link>
              </li>
      ...
      <section id="section-5" className="section-5">
        <div>
          ...
          <div className="aboutUsPara">
            <p>
              We are a team of passionate developers driven by the power of
              artificial intelligence (AI) to revolutionize customer
              interactions. We are committed to creating intelligent and
              engaging AI chatbots that seamlessly blend into the everyday lives
              of businesses and individuals.
            </p>
            <p>
              Our mission is to empower businesses of all sizes with AI-powered
              solutions that enhance customer service, streamline operations,
              and foster personalized experiences. We harness the latest
              advancements in AI technology, coupled with our deep understanding
              of human language and behavior, to craft chatbots that truly stand
              out.
            </p>
          </div>
        </div>
